                                ...
                                <div class="xp-social-profile-img">
                                    <div class="row">
                                        <div class="col-4 px-1">
                                            <img src="{{asset('foto/kelinci.jpg') }}" class="rounded img-fluid" alt="img">
                                        </div>
                                        <div class="col-4 px-1">
                                            <img src="{{asset('foto/kelinci1.jpg') }}" class="rounded img-fluid" alt="img">
                                        </div>
                                        <div class="col-4 px-1">
                                            <img src="{{asset('foto/kelinci2.jpg') }}" class="rounded img-fluid" alt="img">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mt-3">
                                            <div class="xp-social-profile-avatar text-center">
                                                <img src="{{asset('foto/kelinci3.jpg') }}" alt="user-profile" class="rounded-circle img-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="xp-social-profile-title">
                                                <h5 class="my-1 text-black">dnsoktv</h5>
                                            </div>
                                            <div class="xp-social-profile-subtitle">
                                                <p class="mb-3 text-muted">Denis Oktaviano</p>
                                            </div>
                                            <div class="xp-social-profile-desc">
                                                <p class="text-muted">"Peluang nyata untuk sukses terletak dalam diri seseorang dan bukan pada pekerjaanya." <br>Kelas 6B Nim 18090135</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
